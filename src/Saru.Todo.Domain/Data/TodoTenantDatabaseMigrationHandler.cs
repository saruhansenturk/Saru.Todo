...
public class TodoTenantDatabaseMigrationHandler :
    ...
    ITransientDependency
{
    ...
    private readonly ILogger<TodoTenantDatabaseMigrationHandler> _logger;

    public TodoTenantDatabaseMigrationHandler(
        IEnumerable<ITodoDbSchemaMigrator> dbSchemaMigrators,
        ICurrentTenant currentTenant,
        IUnitOfWorkManager unitOfWorkManager,
        IDataSeeder dataSeeder,
        ITenantStore tenantStore,
        ILogger<TodoTenantDatabaseMigrationHandler> logger)
    {
    ...
    public async Task HandleEventAsync(TenantCreatedEto eventData)
    {
        await MigrateAndSeedForTenantAsync(
            eventData.Id,
            eventData.Properties.GetOrDefault("AdminEmail") ?? TodoConsts.AdminEmailDefaultValue,
            eventData.Properties.GetOrDefault("AdminPassword") ?? TodoConsts.AdminPasswordDefaultValue
        );
    }
